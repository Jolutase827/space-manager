    ...
    return (
      <header className='d-flex align-items-center justify-between'>
        <h1 onClick={goToInterface} className="ms-5 d-flex text-[40px] cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" fill="currentColor" className="bi bi-cup-hot me-2" viewBox="0 0 16 16">
            <path fillRule="evenodd" d="M.5 6a.5.5 0 0 0-.488.608l1.652 7.434A2.5 2.5 0 0 0 4.104 16h5.792a2.5 2.5 0 0 0 2.44-1.958l.131-.59a3 3 0 0 0 1.3-5.854l.221-.99A.5.5 0 0 0 13.5 6zM13 12.5a2.01 2.01 0 0 1-.316-.025l.867-3.898A2.001 2.001 0 0 1 13 12.5M2.64 13.825 1.123 7h11.754l-1.517 6.825A1.5 1.5 0 0 1 9.896 15H4.104a1.5 1.5 0 0 1-1.464-1.175Z"/>
          ...
          {user&&<button onClick={logout} className='me-[50px] bg-amber-50 h-[50px] w-[100px] rounded-md hover:bg-slate-300 transition hover:transition hover:text-white'>LogOut</button>}
      </header>
    )
}
