...
function CreateSpace() {
    ...
    const onSubmit = (dataInput, e) => {
        const options= {
            ...
            body: JSON.stringify({"nombre": dataInput.name,"tipo":dataInput.tipo})
        };
    ...
    return (
        <main className="d-flex align-items-center justify-content-center create-user">
            <form className='col-7 rounded pb-3' onSubmit={handleSubmit(onSubmit)}>
                <h2 className='ms-3 align-items-center mt-3'><i className="bi bi-chevron-left me-3" onClick={goBack}></i> Create space</h2>
